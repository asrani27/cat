            ...
            <div class="container">
                <a href="#" class="navbar-brand">
                    <img src="/theme/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light"><strong>Rekrutmen Tenaga RSUD Sultan
                            Suriansyah</strong></span>
                </a>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card card-widget widget-user">
                                    ...
                                    <div class="widget-user-image">
                                        <img class="img-circle" style="background-color:#1a8b41" src="/theme/logo.png"
                                            alt="User Avatar">
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Username
                                                        (NIK)</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="cf-turnstile"
                                                            data-sitekey="{{ config('services.turnstile_site_key') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        {{-- <a href="#" class="btn btn-primary">Jadwal Pendaftaran
                                                            Belum Dimulai</a> --}}
                                                    </div>
                                                </div>

                                                {{-- <div class="form-group row">
                                                    <label for="inputPassword3" class="col-sm-4 col-form-label">Catatan
                                                        :</label>
                                                    <div class="col-sm-8">
                                                        Jika Ada yang kesulitan login atau terkendala teknis lain,
                                                        silahkan hub admin (0812 9425
                                                        2730)
                                                    </div>
                                                </div> --}}
                                            </div>
